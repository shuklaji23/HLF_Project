...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
        --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA \
        -c '{"function": "CreateDocument","Args":["{\"id\":\"1\",\"name\":\"Employee1\",\"addedAt\":1600138309939,\"email\":\"www.email.com\",\"designation\":\"Scientist\"}"]}'
    # setGlobalsForPeer0Org1
...
chaincodeQuery() {
    ...
    # Query Car by Id
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "GetDocumentById","Args":["1"]}'
